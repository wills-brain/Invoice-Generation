...
def render_product_header() -> None:
    ...
    st.caption("Prepared for internal use for Simplex Operations by William Shiu (2026)")
...
def main() -> None:
    ...
    for idx, pdf in enumerate(pdf_files):
        ...
        with col1:
            ...
            if current_po.upper() == "DR" or not current_po:
                st.info("Type the rest of the Fisher Scientific Order Number after the DR prefix.")
            elif not current_po.upper().startswith("DR"):
